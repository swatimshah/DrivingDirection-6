...
model=Sequential()
model.add(Conv1D(filters=80, kernel_size=6, kernel_regularizer=L2(0.0003), bias_regularizer=L2(0.0003), activity_regularizer = L2(0.0003), kernel_constraint=min_max_norm(min_value=-0.4, max_value=0.4), padding='valid', activation='relu', strides=1, input_shape=(64, 30)))
model.add(AveragePooling1D(pool_size=3))
model.add(Conv1D(filters=80, kernel_size=6, kernel_regularizer=L2(0.0003), bias_regularizer=L2(0.0003), activity_regularizer = L2(0.0003), kernel_constraint=min_max_norm(min_value=-0.4, max_value=0.4), padding='valid', activation='relu', strides=1))
model.add(GlobalMaxPooling1D())
model.add(Dense(20, kernel_regularizer=L2(0.0003), bias_regularizer=L2(0.0003), activity_regularizer = L2(0.0003), kernel_constraint=min_max_norm(min_value=-0.4, max_value=0.4), activation='relu'))
